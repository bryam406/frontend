...
import Navbar from './components/basic/Navbar'; // Importa el componente Navbar
import Footer from './components/basic/footer'; // Importa el componente Navbar
import Slider from './components/Inicio/slider'; // Importa el componente Navbar
  ...
  return (
    <Router>
      ...
      <main>
        ...
        <Slider />  {/* Incluye el Slider en el general */}
